...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MainTarget",
            url: "https://github.com/mhays118/TestDistributingXCFrameworks/releases/download/1.0.1/MainTarget.zip",
            checksum: "8f0fb58303b9d0b69f4dcfdbcd589a91e69b0222047295b9ec7bbb6bc98b8f82"
        ),
        .binaryTarget(
            name: "CoreTarget",
            url: "https://github.com/mhays118/TestDistributingXCFrameworks/releases/download/1.0.1/CoreTarget.zip",
